  ...
  <main>
    <div class="bg-primary pt-5 pb-0 position-relative">
      ...
      >
        <svg
          class="vh-100"
          enable-background="new 0 0 628.7 371"
          version="1.1"
        ...
        <div class="row justify-content-center text-center">
          <div class="col-12">
            <figure class="m-0 position-relative z-index-9">
              <svg
                ...
                style="enable-background: new 0 0 291.3 235.4"
                xml:space="preserve"
              >
          ...
          <div class="col-sm-10 col-md-8 col-lg-6 position-relative z-index-1">
            <div class="card card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
              <h2 class="h1 mb-2">Giriş</h2>
              <p>
                Hesabınız yok mu ?<RouterLink :to="{ name: 'Register' }">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-sm-10 col-md-8 col-lg-6">
            <div class="d-grid d-sm-flex justify-content-end align-items-center mt-3">
              <ul class="nav justify-content-center justify-content-endsm-">
                <li class="nav-item">
