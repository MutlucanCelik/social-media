function passwordStrengthMeter(a) {
  ...
  function d(a) {
    1 === a
      ...
      : 4 === a
      ? ((g.className = 'password-strength-meter-score psms-100'),
        k && (k.textContent = l[4] || 'Great password!'),
        f.dispatchEvent(new Event('onScore4', { bubbles: !0 })))
  ...
  document.body.prepend(e),
    ...
    ${a.containerElement} .password-strength-meter-score.psms-25 {width: 25%; background: ${
      a.colorScore1 || '#ff7700'
    };}
    ${a.containerElement} .password-strength-meter-score.psms-50 {width: 50%; background: ${
      a.colorScore2 || '#ffff00'
    };}
    ${a.containerElement} .password-strength-meter-score.psms-75 {width: 75%; background: ${
      a.colorScore3 || '#aeff00'
    };}
    ${a.containerElement} .password-strength-meter-score.psms-100 {width: 100%; background: ${
