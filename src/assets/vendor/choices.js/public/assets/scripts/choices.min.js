  ...
  var e = {
          ...
          E = (function () {
            function e(t, i) {
              ...
              if (
                ...
                var c =
                  i.addItemFilter instanceof RegExp ? i.addItemFilter : new RegExp(i.addItemFilter)
            ...
            return (
              ...
              (e.prototype.clearInput = function () {
                ...
                return (
                  ...
                  !this._isTextElement &&
                    this._canSearch &&
                    ((this._isSearching = !1), this._store.dispatch((0, a.activateChoices)(!0))),
                  this
                )
              }),
              ...
              (e.prototype._createChoicesFragment = function (e, t, i) {
                ...
                var d = u.reduce(
                    function (e, t) {
                      return (
                        t.placeholder ? e.placeholderChoices.push(t) : e.normalChoices.push(t), e
                      )
                    },
              ...
              (e.prototype._onEnterKey = function (e, t, i) {
                ...
                if ((r && (this._handleButtonAction(t, n), e.preventDefault()), i)) {
                  ...
                  a && (t[0] && (t[0].keyCode = s), this._handleChoiceAction(t, a)),
                    e.preventDefault()
              ...
              (e.prototype._onDirectionKey = function (e, t) {
                ...
                if (t || this._isSelectOneElement) {
                  ...
                  if (n || i === o || i === r)
                    l =
                      a > 0
                        ? this.dropdown.element.querySelector(''.concat(c, ':last-of-type'))
              ...
              (e.prototype._addGroup = function (e) {
                ...
                l
                  ? (this._store.dispatch(
                      (0, c.addGroup)({ value: i.label, id: h, active: !0, disabled: u })
                    ),
          ...
          (t.default = function (e, n) {
            switch ((void 0 === e && (e = t.defaultState), void 0 === n && (n = {}), n.type)) {
              case 'ADD_GROUP':
                ...
                return i(
                  i([], e, !0),
                  [{ id: s.id, value: s.value, active: s.active, disabled: s.disabled }],
                  !1
                )
              case 'CLEAR_CHOICES':
                return []
        ...
        var i = {
            ...
            if (
              ...
              var b = 'Remove item',
                S = Object.assign(
                  ...
                  (((s = { type: 'button', className: c })[r ? 'innerHTML' : 'innerText'] = b), s)
                )
          ...
          choiceGroup: function (e, t) {
            ...
            return (
              ...
              u.appendChild(
                Object.assign(
                  document.createElement('div'),
                  (((i = { className: o })[n ? 'innerHTML' : 'innerText'] = l), i)
                )
              ),
              u
            )
          ...
          notice: function (e, t, i) {
            ...
            return (
              ...
              Object.assign(
                document.createElement('div'),
                (((n = {})[s ? 'innerHTML' : 'innerText'] = t), (n.className = h.join(' ')), n)
              )
            )
          },
          option: function (e) {
        ...
        function d(e) {
          ...
          if (s(e) || n(e)) (r = e), (t = p(e)), (i = f(e))
            ...
            if (((r = n), h.call(e, 'weight') && ((o = e.weight), o <= 0)))
              throw new Error(
                ((e) => `Property 'weight' in key '${e}' must be a positive integer`)(n)
              )
            ;(t = p(n)), (i = f(n))
          }
                ...
                if (v) {
                  const e = (function (e = [], t = m.minMatchCharLength) {
                    ...
                    for (let o = e.length; r < o; r += 1) {
                      ...
                      o && -1 === n
                        ? (n = r)
                        : o || -1 === n || ((s = r - 1), s - n + 1 >= t && i.push([n, s]), (n = -1))
                    }
          ...
          search(e, { limit: t = -1 } = {}) {
            ...
            return (
              ...
              (function (
                e,
                t,
                { includeMatches: i = m.includeMatches, includeScore: n = m.includeScore } = {}
              ) {
                const s = []
                return (
                  i && s.push(k),
      ...
      857: function (e, t, i) {
        ...
        function u(e, t, i) {
          ...
          return (
            g({ type: l.INIT }),
            ((n = { dispatch: g, subscribe: v, getState: m, replaceReducer: _ })[a] = y),
            n
          )
        }
        function d(e) {
