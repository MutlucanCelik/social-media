  ...
  (function (e, t) {
    ...
    const We = {
      ...
      createButton(e, t) {
        ...
        return (
          ...
          G(a, i),
          'play' === s
            ? (q(this.elements.buttons[s]) || (this.elements.buttons[s] = []),
      ...
      setQualityMenu(e) {
        ...
        q(e) &&
          (this.options.quality = Ce(e).filter((e) => this.config.quality.options.includes(e)))
          ...
          const e = We.getMenuSize.call(this, i),
            t = (e) => {
              e.target === s &&
                ...
                ((s.style.width = ''), (s.style.height = ''), be.call(this, s, z, t))
            }
          fe.call(this, s, z, t),
    ...
    const Ye = {
        ...
        findTrack(e, t = !1) {
          ...
          let a
          return (
            e.every((e) => ((a = n.find((t) => t.language === e)), !a)), a || (t ? n[0] : void 0)
          )
        },
        getCurrentTrack() {
    ...
    class st {
      ...
      static get prefix() {
        ...
        return (
          ['webkit', 'moz', 'ms'].some(
            (t) =>
              !(!j(document[`${t}ExitFullscreen`]) && !j(document[`${t}CancelFullScreen`])) &&
              ((e = t), !0)
          ),
          e
        )
      ...
      constructor(t) {
        e(this, 'load', () => {
          ...
          e(
            this,
            'on',
            (e, t) => (q(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this)
          ),
                ...
                Object.assign(this, {
                  ...
                  W(e.previewThumbnails) ||
                    ...
                    this.config.previewThumbnails.enabled &&
                      (this.previewThumbnails = new yt(this))),
    ...
    class wt {
      constructor(t, i) {
        if (
          ...
          ((window.jQuery && this.media instanceof jQuery) || D(this.media) || q(this.media)) &&
      ...
      set ratio(e) {
        this.isVideo
          ? _(e) && Pe(e)
            ? ((this.config.ratio = Ne(e)), Me.call(this))
